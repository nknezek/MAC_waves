...
import macmodel_baroclinicRossby as mac
...
dCyr = 10.0 # Period of wave for magnetic boundary condition (years)
...
dir_name = ('../data/k'+str(Nk) + '_l' + str(Nl) +
            '_dC{0:.0e}_m{1:.0f}_nu{2:.0e}_h80_baroclinicRossby/'.format(dCyr, m, nu))
