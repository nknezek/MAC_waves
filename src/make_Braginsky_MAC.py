...
#    B_mag = c['B_mag']
    ...
    dir_name = ('../data/k'+str(Nk) + '_l' + str(Nl) +'_braginksy_MAC'+dir_suf+'/')
    ...
    model.set_B_by_type(B_type=B_type, Bd=Bd, Br=Br, Bth=Bth, const=const, Bmax=Bmax, Bmin=Bmin, sin_exp=sin_exp)
