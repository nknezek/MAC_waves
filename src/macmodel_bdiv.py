...
class Model(macmodel.Model):
    ...
    def make_A_noCCBC(self):
        ...
        # self.rlorentz.add_dth('ur', 'Bth)
        # self.rlorentz.add_dth('uth', '-Br)
        # self.rlorentz.add_dph('ur', 'Bph)
        # self.rlorentz.add_dph('uph', '-Br)
        # self.rlorentz.add_d2_b0('br', C= E/Pm')
        # self.rlorentz.add_dth('bth', C= -E/Pm/r[k]')
        # self.rlorentz.add_dph('bph', C= -E/Pm/r[k]')
        ...
        self.thlorentz.add_d2_bd0('bth', C= E/Pm)
        ...
        self.phlorentz.add_d2_bd0('bph', C= E/Pm)
