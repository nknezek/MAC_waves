...
delta_C = np.sqrt(2*nu/(2*np.pi/T1))  # Core magnetic skin depth for first mode in m
...
filemodel = 'model_k'+str(Nk)+'_l'+str(Nl)+'.p'
...
#%% Save PETSc Matrices
#===============================================================================
fileA = 'A_k'+str(Nk)+'_l'+str(Nl)+'.dat'
fileM = 'M_k'+str(Nk)+'_l'+str(Nl)+'.dat'
